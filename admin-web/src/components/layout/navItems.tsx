...
export const navItems: NavItem[] = [
  ...
  { id: 'customerLayout', path: adminRoutes.customerLayout, label: 'Customer Layout', icon: <Icon name="site" />, description: 'Manage branding, background, SEO, social links, contact and footer.' },
  { id: 'siteSettings', path: adminRoutes.siteSettings, label: 'System Settings', icon: <Icon name="settings" />, description: 'Manage authentication, payments, moderation, email and SMS.' },
