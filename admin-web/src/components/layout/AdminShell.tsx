...
import { CustomerLayoutSettingsPage } from '../../pages/CustomerLayoutSettingsPage';
...
const navGroups: Array<{ title: string; ids: AdminTab[] }> = [
  ...
  { title: 'Operations', ids: ['payments', 'reports', 'settings', 'customerLayout', 'siteSettings', 'externalProviders', 'localities', 'blockedWords', 'health'] },
];
...
function PageRenderer({ tab }: { tab: AdminTab; title: string; description: string }) {
  ...
  if (tab === 'customerLayout') return <CustomerLayoutSettingsPage />;
